...
CONTAINER_NAME="ilm-cli-sonarqube"
...
sonar-scanner \
    ...
    -Dsonar.exclusions="**/*_test.go,cmd/ilmctl/main.go" \
    ...
    -Dsonar.issue.ignore.multicriteria=todogen,todogentest \
    -Dsonar.issue.ignore.multicriteria.todogen.ruleKey=go:S1135 \
    -Dsonar.issue.ignore.multicriteria.todogen.resourceKey=internal/generate/platform.go \
    -Dsonar.issue.ignore.multicriteria.todogentest.ruleKey=go:S1135 \
    -Dsonar.issue.ignore.multicriteria.todogentest.resourceKey=internal/generate/render_test.go
